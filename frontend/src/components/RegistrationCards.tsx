            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-12 w-full max-w-8xl">
                ...
                <Reveal>
                    <div className="text-center max-w-2xl mx-auto mb-16 md:mb-24">
                        <span className="text-xs md:text-sm font-semibold tracking-widest text-red  uppercase mb-6 block">Join the movement</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                        ...
                        <Link to="/register" className="bg-gray-50 rounded-4xl p-10 md:p-14 w-full flex flex-col justify-between border border-gray-100 transform transition-all duration-500 hover:shadow-xl hover:-translate-y-2 group cursor-pointer relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-8">
                                <span className="text-gray-300 text-6xl md:text-[100px] font-black opacity-30 group-hover:text-red group-hover:opacity-10 transition-all duration-500 font-heading leading-none">01</span>
                            </div>
                            ...
                            <div className="relative z-10 flex flex-col h-full min-h-55">
                                <div className="mt-auto">
                                    ...
                                    <div className="flex items-center gap-4 text-red font-medium group-hover:gap-6 transition-all duration-300">
                        ...
                        <Link to="/apply?type=hackathon" className="bg-background rounded-4xl p-10 md:p-14 w-full flex flex-col justify-between transform transition-all duration-500  hover:shadow-xl hover:-translate-y-2 group cursor-pointer relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-8">
                                <span className="text-white text-6xl md:text-[100px] font-black opacity-20 group-hover:text-red group-hover:opacity-30 transition-all duration-500 font-heading leading-none">02</span>
                            </div>
