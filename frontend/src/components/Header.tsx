...
export default function Header() {
    ...
    return (
        ...
        >
            <div className={`mx-auto max-w-8xl transition-all duration-500 overflow-hidden border border-white/5 bg-secondary/80 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.3)]
